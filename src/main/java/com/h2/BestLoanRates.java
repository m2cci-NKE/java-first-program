...
public class BestLoanRates {
	...
	public static void main(String[] args) {
		...
		int loanTermInYears = Integer.parseInt(args[0]);
	...
	public static float getRates(int leanTermYears) {
		
		if (bestRates.containsKey(leanTermYears)) 
			return bestRates.get(leanTermYears);
		return 0.0f;
	}
}
